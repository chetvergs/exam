...
# 1)Создайте из этого списка словарь с тремя ключами python, javascript, java. Значениями должны быть списки с именами
# участников этих курсов
...
# 3)Вам дан список имен:


names = ['Janyl', 'Nursultan', 'Meerim', 'Emir', 'Susann', 'Marcus', 'Aidin', 'Aigerim', 'Angela', 'Albert', 'Jyldyz',
         'Doe', 'Gloria', 'Aliaskar', 'Martin', 'John', 'Andrew', 'Steve', 'Johnathan', 'Adyl', 'Chyngyz', 'Michael',
         'Atay', 'Mikkel', 'Agnes', 'Aidana', 'Sultan', 'Nash', 'Nicolas', 'Mirbek', 'Aktan', 'Emirlan', 'Jennifer',
         'Eniston', 'Alex', 'Mark']
