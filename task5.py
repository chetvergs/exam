...
class Manager(Employee):
    ...
    def __init__(self, name, pin, salary, work_hours):
...
class Seller(Employee):
    ...
    def __init__(self, name, pin, salary, work_hours, sell_count):
        super().__init__(name, pin)
        self.name = name
        self.pin = pin
        self.salary = salary
...
class W_worker(Employee):
    ...
    def __init__(self, name, pin, work_hours):
        super().__init__(name, pin)
        self.name = name
        self.pin = pin
        self.work_hours = work_hours
